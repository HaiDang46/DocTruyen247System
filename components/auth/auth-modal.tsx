    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm animate-fade-in">
      <div className="relative w-full max-w-md overflow-hidden rounded-2xl border border-line bg-surface p-6 shadow-2xl transition duration-300">
        ...
        <div className="flex flex-col items-center gap-1.5 mb-6 text-center">
          ...
          <h2 className="text-xl font-black text-ink mt-2">Chào mừng độc giả</h2>
          <p className="text-xs text-subtle">Đăng nhập để bình luận, đánh giá và lưu lịch sử đọc</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {loading ? "Đang xử lý..." : tab === "login" ? "Đăng nhập" : "Đăng ký thành viên"}
          </button>
        </form>
